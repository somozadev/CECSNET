...
int main()
{
    ...
    printf("-------------------------------\n");
    bool result = test_networking_architecture();
    assert(result == true);
    printf("------------------------------\n");
...
//gcc -Iinclude -o test tests/test.c tests/test_net.c tests/test_ecs.c tests/test_networking_architecture.c src/ecs.c src/ecs_builtin.c src/net_socket.c src/connection_manager.c src/protocol_handler.c src/network_architecture.c src/network_cs.c -lws2_32